  ...
  return (
    <>
      ...
      <section className="movie">
        {/* bg (can be removed) */}
        <Image
          className="movie__bg object-cover"
          src={`${process.env.NEXT_PUBLIC_CDN_IMAGE_MOVIE}/uploads/movies/${detail.item.poster_url}`}
          fill
            ...
            <div className="col-12 col-lg-10  col-xl-12  col-xxl-8 ">
              <div className="movie__content">
                <h1 className="hero__title">
                  {detail.item.name}{" "}
                  <sub className="gold">
                    {Number(detail.item.tmdb.vote_average?.toFixed(1))}
                  </sub>
                </h1>
                <p
                ...
                <ul className="hero__meta">
                  ...
                  <li>
                    <span>Tập hiện tại: </span> {detail.item.episode_current}
                  </li>
                  <li>
                    <span>Quốc Gia: </span>
                ...
                <div className="hero__actions">
                  <Link href={"/movie/play/" + detail.item.slug}>
                    <button className="btn-trailer">Xem phim</button>
                  </Link>

                  {detail.item.trailer_url && (
                    <button
                      className="hero__btn hero__btn--review"
                      type="button"
